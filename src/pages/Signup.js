...
<Link to="/" style={{color: 'inherit', textDecoration: 'none', display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
     ...
     <span style={{color: 'white', fontSize: '26px', fontWeight: 600, lineHeight: '38px', letterSpacing: '-1.213342308998108px', textAlign: 'left'}}>Mpawa</span> 
   </Link>
 </div>
      <div className="mpawatext">
        Promote Health and Wellness for Women with Our Educational Programs and Support Groups.
      </div>
    </div>
  </div>
  <div className="loginbox2">
    ...
    <div className="forminput" style={{padding: '5px', width: '100%'}}>
      <a href>
        <button style={{fontFamily: 'inherit', width: '100%', fontSize: '14px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#efd4ab', color: '#1E293B', padding: '13px 27px', fontWeight: 700, margin: '8px 0', border: 'none', borderRadius: '4px', cursor: 'pointer', transition: 'all .4s ease'}}>
          <svg style={{padding: '0px 11px 0 0', width: 'fit-content'}} xmlns="http://www.w3.org/2000/svg" height={24} viewBox="0 0 24 24" width={24}><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4" /><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853" /><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05" /><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335" /><path d="M1 1h22v22H1z" fill="none" /></svg>
          Sign in with Google
        </button>
      </a>
    </div>
        ...
        <div className="loginform">
          <div className="formcontent">
            ...
            <div className="forminput">
              <input type="text" placeholder="enter your username" name="username" id="id_username" />
            </div>
          </div>
          <div className="formcontent">
            <div className="label">
            ...
            <div className="forminput">
              <input type="email" placeholder="enter your email" name="username" id="id_username" />
            </div>
          </div>
          <div className="formcontent">
            <div className="label">
            ...
            <div className="forminput">
              <input type="password" placeholder="enter your password" name="username" id="id_username" />
            </div>
          </div>
          <div className="formcontent">
            <div className="forminput">
          ...
          <span className="create">
            Already have an account? <Link to="/signin" style={{color: '#E56346'}}>Login </Link>
          </span>
        </div>
      </form>
    </div>
