    ...
    <div className="loginform">
      <div className="formcontent">
        ...
        <div className="forminput">
          <input type="text" placeholder="enter your username" name="username" id="id_username" required />
        </div>
      </div>
      <div className="formcontent">
        <div className="label">
        ...
        <div className="forminput">
          <input type="email" placeholder="**********" name="username" id="id_username" required />
        </div>
      </div>
      <div className="formcontent">
        <div className="forminput">
          <input type="submit" defaultValue="Login" style={{width: 'fit-content'}} />
        </div>
      </div>
      <span className="create">
     
        Don’t have an account?<Link to="/signup" style={{color: '#E56346'}}>Create Account </Link>
      </span>
    </div>
  </form>
</div>
